    ...
    OJPRequest: [
      {
        ServiceRequest: [
          {
            RequestTimestamp: ["2021-07-23T23:07:14.243Z"],
            RequestorRef: ["API-Explorer"],
                ...
                "ojp:Location": [
                  {
                    ...
                    "ojp:DepArrTime": ["2021-07-24T01:07:14"],
                  },
                ],
                "ojp:Params": [
                  {
                    "ojp:NumberOfResults": ["1"],
                    "ojp:StopEventType": ["departure"],
                    "ojp:IncludePreviousCalls": ["true"],
                    "ojp:IncludeOnwardCalls": ["true"],
